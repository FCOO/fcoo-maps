    ...
    var MapSettingGroup = function(map){
        ...
        *****************************************************************************/
        ...
        $.each({
            ...
            'bsMapSyncInfoControl': this.map.options.isMainMap ?
                                        {icon: 'fa-clock', text:{da:'Aktuelle tidspunkt', en:'Current Time'}} :
                                        {icon: ['fa-clock', 'fa-sync'], text:{da:'Aktuelle tidspunkt / Synkronisering', en:'Current Time / Synchronizing'}},
            'bsLegendControl'     : ns.mapLegendHeader,
