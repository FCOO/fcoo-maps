    ...
    ns.appSetting.add({
        ...
        applyFunc: function(options){
            if (nsMap.hasMultiMaps){
                ...
                //Update the options showShadowCursor and showOutline for map-sync (See fcoo-maps-map-sync.js)
    ...
    nsMap.editMultiMapsAndSyncMapsSetting = function(){
        if (!mapSettingModalForm){
            ...
            mapSettingModalForm = $.bsModalForm({
                ...
                keyboard  : true,
                content   : content,
                footer    : [{da:'Klik på', en:'Click on'}, {icon: ns.mapSettingIcon}, {da:'&nbsp;i kortet for at sætte synkronisering', en:'&nbsp;in the map to set synchronization'}],
//MANGLER                footer : {icon:'fa-square-full text-multi-maps-main', text:{da:':&nbsp;Hovedkort',  en:':&nbsp;Main map'}},
