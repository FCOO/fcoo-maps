...
//console.log('MANGLER timeMode=', timeMode);
    ...
    ******************************************************************/
    L.Map.addInitHook(function () {
        ...
        //this.on('hideinmultimaps', not_needed, this);

        //Create timeInfoControl = mini-version of L.Control.BsMapSyncInfoControl with only current time
        if (this.options.timeInfoControl && this.options.isMainMap) {
            this.bsMapSyncInfoControl = new L.Control.BsMapSyncInfoControl({isMainMap: true});
    ...
    ******************************************************************/
    L.Map.prototype._updateTime = function(){
        ...
        if (this.bsMapSyncInfoControl && this.options.mapSync && this.options.mapSync.timeOffset){
        ...
        //Update bsMapSyncInfoControl
        if (this.bsMapSyncInfoControl)
            this.bsMapSyncInfoControl.$currentTime.vfValue(this.time.current);
